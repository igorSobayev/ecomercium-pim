...
<div class="wrapper fadeInDown">
    <div id="formContent">
        ...
        <form method="POST" action="{{ route('login') }}" class="mt-3">
            @csrf
            <input id="email" type="email" class="fadeIn second @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" required autocomplete="email" autofocus placeholder="Usuario (email)">
            @error('email')
